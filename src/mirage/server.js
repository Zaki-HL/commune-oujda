...
createServer({
	...
	seeds(server) {
		...
		server.create('article', {
			id: '2',
			title: 'Oujda-Angad : Approbation d une série de projets INDH à fort impact socio-économique',
			title_ar: 'وجدة - أنجاد: الموافقة على سلسلة مشاريع INDH القوية	التأثير الاجتماعي والاقتصادي',
			...
			body_ar: 'وتميز الاجتماع ، الذي ترأسه والي المنطقة الشرقية ومحافظ محافظة وجدة - أنجاد ، معاد الجامعي ، بعرض حالة التقدم في مشاريع المبادرة الوطنية للتنمية البشرية المبرمجة. لعام 2019 ، وخطة العمل المتعلقة بإدارة منصة الشباب في محافظة وجدة - أنجاد.',
			image: <img src={imgEvenement1} alt="image"/>,
			date: '13 Mars 2023',
		});
		server.create('article', {
			id: '3',
			title: 'OFPPT : Quatre nouvelles Cités des Métiers et des Compétences ouvriront leurs portes en 2023',
			...
			body_ar: 'بعد انطلاق المدن الثلاث من المدن والكفاءات في مناطق سوس ماسة والورينتال والعيون الساقية الحمراء ، سيفتح أربعة آخرون أبوابهم هذا العام في مناطق الرباط - سلا القنيطرة ، الدار البيضاء- سطات ، بني ملال خنيفرة وطنجة تطوان الحسيمة.			',
		...
		server.create('article', {
			...
			body_ar: 'المرحلة الثانية من عملية سداد رسوم الحج لموسم 1444 هجرية للمسجلين في قوائم الانتظار حسب الترتيب الذي تحدده عملية القرعة والذين سيحلون محل غير القادرين على دفع رسوم الحج لعام 1444 أعلنت وزارة الأوقاف والشؤون الإسلامية ، اليوم الاثنين ، أن الموسم خلال المرحلة الأولى ، سيقام في الفترة من 23 إلى 29 مارس 2023.			',
			image: <img src={imgHajj} alt="image"/>,
			date: '13 Mars 2023',
		});
		server.create('article', {
			id: '5',
			title: 'Le Maroc doit adapter son économie à la menace climatique croissante',
			...
			body_ar: 'قالت وزيرة الاقتصاد والمالية نادية فتاح العلوي إن المغرب يجب أن يكيّف اقتصاده لمواجهة التهديد المتزايد للتغير المناخي الذي يتسبب في مزيد من موجات الجفاف المتكررة.			',
			image: <img src={imgImage2} alt="image"/>,
			date: '12 Mars 2023',
		});
		server.create('article', {
			id: '6',
			title: 'Appel à communication pour la 3e conférence «Marchés du travail et transformations structurelles»',
			title_ar: 'دعوة للمشاركة في المؤتمر الثالث "أسواق العمل	والتحولات الهيكلية "',
			...
			body_ar: 'يطلق بنك المغرب والشبكة الإقليمية لإدارات البحث في البنوك المركزية للشرق الأوسط وشمال إفريقيا دعوة لتقديم أوراق بحثية للمؤتمر السنوي الثالث للشبكة الذي سيعقد يومي 14 و 15 سبتمبر 2023 في الرباط ، بصيغة مختلطة ، حول موضوع "أسواق العمل والتحولات الهيكلية". الموعد النهائي للتقديم هو 14 مايو 2023.			',
			image: <img src={imgImage3} alt="image"/>,
			date: '12 Mars 2023',
		});
		server.create('article', {
			id: '7',
			title: 'Programme ProFuturo : La Fondation BMCE Bank pour l’Education et l’Environnement enrichit son programme d’éducation numérique',
			title_ar: 'برنامج ProFuturo: مؤسسة BMCE Bank للتعليم و	تثري البيئة برنامج التعليم الرقمي الخاص بها',
			...
			body_ar: 'وقع BMCE Bank Foundation for Education and Environment اتفاقية تعاون مع مؤسسة ProFuturo تهدف إلى تعزيز وتشجيع تدريب الأطفال والشباب والمعلمين والأشخاص المعرضين لخطر الإقصاء الاجتماعي.			',
			image: <img src={imgImage4} alt="image"/>,
			date: '11 Mars 2023',
		});
		server.create('article', {
			id: '8',
			title: 'Libertés fondamentales: structurées et audacieuses, les propositions de réforme d un collectif inédit',
			title_ar: 'الحريات الأساسية: منظم وجريء ، مقترحات إصلاح جماعية غير مسبوقة			',
		...
		server.create('evenement', {
			id: '1',
			title: 'Festival Action: Danse 7 Oujda & Casablanca Au programme: Gaby Saranouffi Low Rize...',
			title_ar: 'مهرجان أكشن: رقص 7 وجدة والدار البيضاء على برنامج: غابي سارانوفي لو ريزي ...			',
		...
		server.create('evenement', {
			id: '2',
			title: 'Inscriptions ouvertes, 3 passages sur scène dans la journée🤩Vous avez un groupe de Danse...',
			title_ar: 'التسجيلات مفتوحة ، 3 ظهورات على خشبة المسرح خلال النهار	🤩 هل عندك فرقة رقص ...',
			...
			body_ar: 'التسجيلات مفتوحة ، 3 ظهورات على خشبة المسرح خلال النهار	لديك مجموعة رقص (جميع الأنماط مرحب بها وحتى تريد!) من سن 6 سنوات إلى ... بلا حد للعمر ... لا تتردد ، قدم طلب التسجيل وتعال وشارك معنا هذا اليوم السحري ، بدون إصدار حكم ، فقط المشاركة ومتعة اكتشاف رقصات الآخرين (الموعد النهائي أكتوبر 31)',
		...
		server.create('evenement', {
			id: '4',
			title: 'Oujda... L’Université Mohammed I participe à la commémoration du 20e anniversaire de l’Initiative royale de développement de l’Est',
			title_ar: 'وجدة ... جامعة محمد الأول تشارك في الاحتفال	الذكرى العشرين للمبادرة الملكية لتطويرالشرق',
		...
		server.create('evenement', {
			...
			body_ar: 'في إطار أسبوع الفرانكفونية وعلى هامش النسخة الخامسة والعشرين من ربيع الشعراء ، ينظم المعهد الفرنسي لوجدة بالشراكة مع الجمعية المغربية للمعلمين الفرنسيين سي بي وجدة "La NUIT DE LA POÉSIE" يوم الجمعة 31 مارس ، 2023 من الساعة 10 مساءً',
		...
		server.create('annonce', {
			id: '2',
			title: 'Publication de la liste des convoqués pour l appel à candidature pour le poste Appel à candidature pour le poste de Chef de service (Services centraux) (1) poste au Agence Nationale de la Sécurité Routière (NARSA)',
			title_ar: 'نشر قائمة المستدعين للدعوة لتقديم الطلبات للمناصب. دعوة لتقديم الطلبات لمنصب رئيس الخدمة (الخدمات المركزية) (1) في الوكالة الوطنية للسلامة على الطرق (NARSA)',
			image: 'no image',
			date: '16 Mars 2023',
		});
		server.create('annonce', {
			id: '3',
			title: 'Annulation de l appel à candidature pour le poste expert (1) poste au Ministère de la Transition énergétique et du Développement durable - Département du Développement durable',
			title_ar: 'إلغاء دعوة تقديم الطلبات لشغل منصب خبير (1) في وزارة الطاقة الانتقالية والتنمية المستدامة - إدارة التنمية المستدامة',
			image: 'no image',
			date: '15 Mars 2023',
		});
		server.create('annonce', {
			id: '4',
			title: 'Appel à candidature pour le poste expert (1) poste au Ministère de la Transition énergétique et du Développement durable - Département du Développement durable',
			title_ar: 'دعوة لتقديم الطلبات لشغل منصب خبير (1) في وزارة الطاقة الانتقالية والتنمية المستدامة - إدارة التنمية المستدامة',
			image: 'no image',
			date: '15 Mars 2023',
		});
		server.create('annonce', {
			id: '5',
			title: 'Publication de la liste des convoqués pour le concours de recrutement d un AGENT DE MAITRISE (2) postes à la Société des Silos Portuaires (SOSIPO)',
			title_ar: 'نشر قائمة المستدعين لمسابقة التوظيف لمنصب مدير (2) في Société des Silos Portuaires (SOSIPO)',
			image: 'no image',
			date: '14 Mars 2023',
		});
		server.create('annonce', {
			id: '6',
			title: 'Appel à candidature pour le poste RESPONSABLE ADMINISTRATIF ET FINANCIER (1) poste au Casablanca Iskane et Equipements',
			title_ar: 'دعوة لتقديم الطلبات لشغل منصب مدير إداري ومالي (1) في شركة الدار البيضاء إسكان والمعدات',
			image: 'no image',
			date: '14 Mars 2023',
		});
		server.create('annonce', {
			id: '7',
			title: 'Appel à candidature pour (6) postes de chef de division et (16) postes de chef de service ou assimilés au Ministère de la Santé et de la Protection sociale',
			title_ar: 'دعوة لتقديم طلبات (6) وظائف رئيس شعبة و (16) منصب رئيس خدمة أو ما في حكمها بوزارة الصحة والحماية الاجتماعية',
			image: 'no image',
			date: '13 Mars 2023',
		});
		server.create('annonce', {
			id: '8',
			title: 'Annulation du concours de recrutement d un Adjoint technique 3ème grade ~ Echelle 6 (3) postes au Conseil provincial (Province Chefchaouen)',
			title_ar: 'إلغاء مسابقة الاستقدام لمساعد تقني من الدرجة الثالثة ~ مقياس 6 (3) في مجلس المحافظة (ولاية شفشاون)',
			image: 'no image',
			date: '13 Mars 2023',
		});
		// End Annonces
